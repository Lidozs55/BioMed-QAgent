...
export const CORE_ACQUISITION_PROVIDER_DESCRIPTORS: readonly CoreAcquisitionProviderDescriptor[] = Object.freeze([
  ...
  descriptor(EXTENDED_PROVIDER_IDS.europePmcPdf, "europepmc_pdf", "fixed", "One frozen PMCID per binding; acquires the official Europe PMC full-text PDF carrier.", "binary_archive", null),
  descriptor(EXTENDED_PROVIDER_IDS.europePmcFulltextXml, "europepmc_fulltext_xml", "fixed", "One frozen PMCID per binding; acquires the official Europe PMC full-text XML carrier.", "binary_archive", null),
