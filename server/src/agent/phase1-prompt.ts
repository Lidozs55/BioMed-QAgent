...
const DATASET_COMPLETION_CONTRACT = [
  ...
  "Before substantive acquisition, call inspect_dataset_build_routes, use its current route and input facts, then declare the matching semantic family, projection, and row granularity. Build one family and granularity at a time; split a request with multiple semantic products into separate builds.",
