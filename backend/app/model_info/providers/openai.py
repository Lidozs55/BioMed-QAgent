...
MODELS: dict[str, ModelDetail] = {
    ...
    "gpt-5.6": ModelDetail(
        id="gpt-5.6",
        name="GPT-5.6",
        description="OpenAI GPT-5.6 旗舰模型，1M 上下文窗口，128K 最大输出。",
        vendor_id="openai",
    ...
    "gpt-5.6-luna": ModelDetail(
        id="gpt-5.6-luna",
        name="GPT-5.6 Luna",
        description="OpenAI GPT-5.6 Luna 轻量版，1M 上下文窗口，128K 最大输出。",
        vendor_id="openai",
        input_context_window=1_000_000,
        max_output_tokens=128_000,
        suggested_max_tokens=128_000,
    ...
    "gpt-5.6-terra": ModelDetail(
        id="gpt-5.6-terra",
        name="GPT-5.6 Terra",
        description="OpenAI GPT-5.6 Terra 中端版，1M 上下文窗口，128K 最大输出。",
        vendor_id="openai",
        input_context_window=1_000_000,
        max_output_tokens=128_000,
        suggested_max_tokens=128_000,
    ...
    "gpt-5.6-sol": ModelDetail(
        id="gpt-5.6-sol",
        name="GPT-5.6 Sol",
        description="OpenAI GPT-5.6 Sol 旗舰版，1M 上下文窗口，128K 最大输出。",
        vendor_id="openai",
        input_context_window=1_000_000,
        max_output_tokens=128_000,
        suggested_max_tokens=128_000,
